...
df <- fread("results/str_coex/FG-metrics_coexistence-complete-4spp.txt")
...
fig3b_only <- ggarrange(fig3b3, fig3b1, fig3b2,
                        fig3b4, fig3b5, fig3b6,
                        nrow = 2, ncol = 3,
                        common.legend = TRUE,
                        legend = "bottom",
...
ggsave(fig3a, filename = "figures/4metrics_coex_SND-4spp.png", device = "png",
       width = 10.5, height = 8, dpi = 320)

ggsave(fig3b_only, filename = "figures/4metrics_coex_SFD-4spp.png", device = "png",
       width = 10.5, height = 8, dpi = 320)

ggsave(fig4, filename = "figures/4metrics_coex-4spp.png", device = "png",
