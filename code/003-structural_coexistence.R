...
#save both
write.table(str_coex, "results/str_coex/FG-structural_coexistence-complete.txt", sep = "\t", row.names = FALSE)
write.table(metrics, "results/str_coex/FG-metrics_coexistence-complete.txt", sep = "\t", row.names = FALSE)
...
write.table(str_coex, "results/str_coex/FG-structural_coexistence.txt", sep = "\t", row.names = FALSE)
write.table(metrics, "results/str_coex/FG-metrics_coexistence.txt", sep = "\t", row.names = FALSE)
